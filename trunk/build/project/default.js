// sync with Project.wxs VsVersion
var VsVersion = "v100";
...
// HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\VisualStudio\10.0\ShellDir
...
//		var pfiles = shell.RegRead("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\ProgramFilesDir");
		...
		var version;
		try {
			path = "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Office\\15.0\\Excel\\InstallRoot\\Path";
		...
		var CompileTool = config.Tools('VCCLCompilerTool');
		CompileTool.AdditionalIncludeDirectories = TargetDir;
		CompileTool.BasicRuntimeChecks = basicRuntimeCheckOption.runtimeBasicCheckAll;
		CompileTool.DefaultCharIsUnsigned = true;
		CompileTool.DebugInformationFormat = debugOption.debugEnabled;
		CompileTool.WarningLevel = warningLevelOption.warningLevel_4;
		CompileTool.Optimization = optimizeOption.optimizeDisabled;
		CompileTool.PreprocessorDefinitions = "WIN32;_DEBUG;_WINDOWS;";
		CompileTool.RuntimeLibrary = runtimeLibraryOption.rtMultiThreadedDebug;
		CompileTool.UsePrecompiledHeader = pchOption.pchNone;
		CompileTool.MinimalRebuild = false;
		CompileTool.WarnAsError = true;
		...
		LinkTool.AdditionalLibraryDirectories = "\"" + TargetDir + VsVersion + "\\Debug\\\"";
 		LinkTool.AdditionalDependencies += "xll.lib"; 
		...
		var CompileTool = config.Tools('VCCLCompilerTool');
		CompileTool.AdditionalIncludeDirectories = TargetDir;
		CompileTool.BasicRuntimeChecks = basicRuntimeCheckOption.runtimeBasicCheckNone;
		CompileTool.DefaultCharIsUnsigned = true;
		CompileTool.DebugInformationFormat = debugOption.debugDisabled;
		CompileTool.WarningLevel = warningLevelOption.warningLevel_4;
		CompileTool.Optimization = optimizeOption.optimizeMaxSpeed;
		CompileTool.PreprocessorDefinitions = "WIN32;NDEBUG;_WINDOWS;";
		CompileTool.RuntimeLibrary = runtimeLibraryOption.rtMultiThreaded;
		CompileTool.UsePrecompiledHeader = pchOption.pchNone;
		CompileTool.MinimalRebuild = false;
		CompileTool.WarnAsError = true;
		...
		LinkTool.LinkTimeCodeGeneration = LinkTimeCodeGenerationOption.LinkTimeCodeGenerationOptionUse;
		LinkTool.SubSystem = subSystemOption.subSystemWindows;
		LinkTool.TargetMachine = machineTypeOption.machineX86;
 		LinkTool.AdditionalLibraryDirectories = "\"" + TargetDir + VsVersion + "\\Release\\\"";
 		LinkTool.AdditionalDependencies += "xll.lib"; 
	}
	catch(e)
	{
